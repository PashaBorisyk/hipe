...
object EventService {
    ...
    fun cancelEvent(requestID: Long, eventId: Long, userId: Long = MyApplication.THIS_USER_ID) {
        Log.d(TAG, "cancelEvent() called with: eventId = [$eventId]")
        eventEvoke.cancelEvent(userId, eventId).enqueue(LongCallback(requestID))
    }

    fun addMemberToEvent(requestID: Long, eventId: Long, advancedUserId: Long, userId: Long = MyApplication.THIS_USER_ID) {
    ...
    fun getEvents(requestID: Long, latitude: Double, longtitude: Double, plastReadEventId: Long, userId: Long = MyApplication.THIS_USER_ID) {
    ...
    fun getByMemberId(requestID: Long, userId: Long = MyApplication.THIS_USER_ID) {
